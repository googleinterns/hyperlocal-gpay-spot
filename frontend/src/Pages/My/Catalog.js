...
class Catalog extends React.Component {
  ...
  submitCatalog = () => {
    ...
    axios.post("http://penguin.termina.linux.test:8080/api/shop/"+this.state.shopID+"/catalog/update", {
      add: itemsToAdd,
      edit: itemsToEdit,
  ...
  resetAndReloadServices = () => {
    return axios.get("http://penguin.termina.linux.test:8080/api/shop/"+this.props.user.shop.shopID)
    .then(res => {
